...
class Interfaz:
    def __init__(self, ventana):
        ...
        self.pantalla=Text(ventana, state="disabled",
                            width=40, height=3, background="gray",
    ...
    def crearBoton(self, valor, escribir=True,
                    ancho=9, alto=1):
        return Button(self.ventana, text=valor,
                     width=ancho, height=alto, font=("Helvetica",15),
                       command=lambda:self.click(valor,escribir))


    #Controla el evento disparado al
    #  hacer click en un botón
    def click(self, texto, escribir):
        #Si el parámetro 'escribir' es True,
        #  entonces el parámetro texto debe mostrarse en pantalla. Si es False, no.
        if not escribir:
            #Sólo calcular si hay una operación a
            #  ser evaluada y si el usuario presionó '='
            if texto=="=" and self.operacion!="":
                #Reemplazar el valor unicode de la división
                #  por el operador división de Python '/'
    ...
    #Muestra en la pantalla de la calculadora el
    #  contenido de las operaciones y los resultados
